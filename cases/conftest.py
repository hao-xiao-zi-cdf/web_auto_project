...
def _build_artifact_test_folder(pytestconfig: Any, request: pytest.FixtureRequest, folder_or_file_name: str) -> str:
    ...
    # output/test_add_project_001/test-failed-1.png
    # output/test_register_002/test-success-1.png
...
def fresh_context(browser, base_url, pytestconfig, browser_context_args: Dict):
    """
...
def unlogin_page(fresh_context: BrowserContext, pytestconfig: Any, request: pytest.FixtureRequest):
    ...
    """
    pages: List[Page] = []
    fresh_context.on("page", lambda page: pages.append(page))
